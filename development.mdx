...
<Info>
  **Prerequisite (real)**: Please install Node.js (version 19 or higher) before proceeding. \\

  Please upgrade to `docs.json` before proceeding and delete the legacy `mint.json` file.
</Info>

Follow these [step](/essentials/markdown)s:

**Step 1**: Install [Mintlify](/api-reference/endpoint/create):
